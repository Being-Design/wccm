 ...
 * make user roles available as a variable.
 */
...
<div id="item-header-cover" class="table">
	...
	/*
	 * BEING THEME CUSTOMIZATION:
	 * Alternate Profile Layout - this affects the classes used
	 */
	$alternate = false;
	if ( get_option('alternate_profile_layout') == true )
		$alternate = true;
	?>

    <div class="<?php echo ( $alternate ) ? 'member-header-wrapper' : 'table-cell'; ?>">

        <div class="<?php echo ( $alternate ) ? 'member-header-container center-margin' : 'table cover-content'; ?>">

            <div class="<?php echo ( $alternate ) ? 'member-header-userinfo' : 'table-cell'; ?>">
            ...
            <div class="member-actions-container table-cell">
                ...
                <div id="item-statistics">
					...
					/*
					 * BEING THEME CUSTOMIZATION:
					 * Hide numbers/stats on user profile's (Points/Friends/Followers)
					 */
					if ( get_option('hide_profile_stats') != true ) : ?>
                    <div class="numbers">
