...
<div id="buddypress" >
    ...
    <div class="<?php echo ( boss_get_option( 'boss_layout_style' ) == 'boxed' && is_active_sidebar( 'profile' ) && bp_is_user() ) ? 'right-sidebar' : 'full-width'; ?>">
        <div id="item-main-content">
            <?php if( (get_option('display_item_nav_in_profile') == true ) && (!bp_is_current_component('events') || ( bp_is_current_component('events') && 'profile' == bp_current_action() )) ): //show if not Events Manager page or My Profile of Events ?>
            <div id="item-nav">
