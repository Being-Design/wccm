        ...
        onPlaceChangedStreet: function () {
            ...
            for (var i = 0; i < place.address_components.length; i++) {
                ...
                if (componentForm[addressType]) {
                    ...
                    if ( 'field_0' != _city && 'locality' == addressType ) {
                        city_selector.value = val;
                    }
                    if ( 'field_0' != _state && 'administrative_area_level_1' == addressType ) {
                        state_selector.value = val;
                    }
                    if ( 'field_0' != _country && 'country' == addressType ) {
                        country_selector.value = val;
                    }
                    if ( 'field_0' != _zip && 'postal_code' == addressType ) {
