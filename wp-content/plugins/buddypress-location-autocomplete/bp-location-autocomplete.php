...
if ( ! defined( 'BUDDYBOSS_BPLA_PLUGIN_VERSION' ) ) {
	define( 'BUDDYBOSS_BPLA_PLUGIN_VERSION', '1.2.0' );
}
...
if ( !function_exists( 'register_buddyboss_menu_page' ) ) {
	...
	function register_buddyboss_menu_page() {
		...
		add_menu_page( 'BuddyBoss', 'BuddyBoss', 'manage_options', 'buddyboss-settings', '', bp_bpla()->assets_url . '/images/logo.svg', 61.000129 );
